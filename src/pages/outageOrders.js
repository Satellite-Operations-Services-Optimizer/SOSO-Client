...
import OutageOrderCreationModal from "../components/order_creation_modals/OutageOrderCreationModal";
import { Box, Tab, Tabs, Select, InputLabel, MenuItem, FormControl, Chip } from "@mui/material";

export default function OutageOrders() {
        ...
        <div className="dashboardContent">
          <div className={styles.dashboardMainContent}>
            <Container className={styles.container}>
              ...
              <Box sx={{ width: "100%", marginBottom: "15px" }}>
                {tab === 0 && <OrderView orderType="outage" preselectedRows={preselectedOrderRows.current} onSelectionChanged={onSelectionChanged}/>} 
                {tab === 1 && <RequestsView orderType="outage" orderIds={requestViewOrderIds}/>}
              </Box>
            </Container>
          </div>
        </div>
      </main>
      <OutageOrderCreationModal
        showModal={showModal} 
